<?php
    ...
    $structureQuery = "select
        ...
        sr.id_user IS NOT NULL favourite
    from recipes r
    ...
    left join saved_recipes sr on r.id = sr.id_recipe and sr.id_user = :userID
    group by r.id, title, image, r.description, calories, time, cuisine, category, favourite
